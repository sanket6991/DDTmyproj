...
public class OpenAccountTest extends TestBase {
	...
	public static void openAccountTest(String Customer, String Currency)
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(OR.
		getProperty("currency_CSS")))); select("currency_CSS",Currency);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(OR.
		getProperty("process_CSS")))); click("process_CSS");
		/*
		 * Alert alert = wait.until(ExpectedConditions.alertIsPresent());
		 * Assert.assertTrue(alert.getText().
		 * contains("Account created successfully with account Number"));
		 * alert.accept();*/
